...
const LaunchApp = () => {
  ...
  return (
    <Box sx={styles.wrapper}>
      ...
      >
        <Box sx={{ textAlign: "center", width: "100%", justifyContent: "center", display: "flex" }}>
          <Box sx={styles.content}>
            <Typography variant="h1">The home for every creator</Typography>
            <Typography variant="h5" sx={styles.noteTextStyles}>
